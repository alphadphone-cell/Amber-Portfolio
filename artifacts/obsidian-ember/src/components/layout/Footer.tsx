  ...
  return (
    <footer className="relative mt-24 overflow-hidden border-t border-[rgba(245,158,11,0.12)] bg-background/95 py-14">
      ...
      <div className="container relative mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 md:grid-cols-[1.1fr_0.9fr_1.1fr] md:items-start">
        ...
        >
          <a href="#about" className="text-sm font-mono text-muted-foreground transition-colors hover:text-primary focus-visible:outline-2 focus-visible:outline-primary rounded-sm">01. About</a>
          <a href="#projects" className="text-sm font-mono text-muted-foreground transition-colors hover:text-primary focus-visible:outline-2 focus-visible:outline-primary rounded-sm">02. Projects</a>
          <a href="#experience" className="text-sm font-mono text-muted-foreground transition-colors hover:text-primary focus-visible:outline-2 focus-visible:outline-primary rounded-sm">03. Experience</a>
          <a href="#blog" className="text-sm font-mono text-muted-foreground transition-colors hover:text-primary focus-visible:outline-2 focus-visible:outline-primary rounded-sm">04. Blog</a>
          <a href="#contact" className="text-sm font-mono text-muted-foreground transition-colors hover:text-primary focus-visible:outline-2 focus-visible:outline-primary rounded-sm">05. Contact</a>
        </nav>

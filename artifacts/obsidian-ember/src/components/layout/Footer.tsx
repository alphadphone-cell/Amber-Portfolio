...
export function Footer() {
  return (
    <footer className="relative mt-24 overflow-hidden border-t border-[rgba(245,158,11,0.10)] bg-transparent py-14">
      <div
      ...
      <div className="container relative mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 md:grid-cols-[1.1fr_0.9fr_1.1fr] md:items-start">
        <div className="rounded-[28px] border border-[rgba(245,158,11,0.10)] bg-[rgba(6,4,2,0.22)] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.16)] backdrop-blur-2xl backdrop-saturate-150">
        ...
        <nav
          className="rounded-[28px] border border-[rgba(245,158,11,0.10)] bg-[rgba(6,4,2,0.18)] p-5 backdrop-blur-2xl backdrop-saturate-150"
          aria-label="Footer navigation"
        >
          <div className="flex flex-wrap justify-start gap-x-8 gap-y-3 md:justify-center">
        ...
        <div className="flex flex-col items-stretch gap-4 md:items-end">
          <div className="rounded-[28px] border border-[rgba(245,158,11,0.10)] bg-[rgba(6,4,2,0.16)] p-3 shadow-[0_18px_40px_rgba(0,0,0,0.12)] backdrop-blur-2xl backdrop-saturate-150">
            <BackgroundMusic />
          </div>
